...
void Usage(FILE* out) {
  std::fprintf(
      ...
      "\n"
      "Reads primeparts.flat_parts and primeparts.higher_parts over the REST\n"
      "catalog, expanding each flat hit mask to q = p - 2^m_k, and reports the\n"
      "induced poset on the queried prime window: the Hasse diagram (cover\n"
      "relation), a minimum chain decomposition, and the antichains witnessing\n"
      "its width.\n"
      "\n"
      "Options:\n"
