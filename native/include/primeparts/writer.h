...
struct WriterConfig {
  ...
  // compressed at the base-table ~1.1 B/row. Smaller, denser tables (e.g. mdiff,
  // ~2.2 B/row) set this lower to hit a target row-group byte size so readers can
  // prune by per-column min/max stats.
